...
class BAIDU_PUSH_CONFIG {
     ...
     * @var string
     */
    const default_apiKey = 'dGDKbPIrZ561HRPKbeECXGQv';
     ...
     * @var string
     */
    const default_secretkey = 'Gwe1bEAlGIW8eZkNovxduTgAn8929C5E';
     ...
     * @var string
     */
    const test_channel_id = '5490126185581469391';
     ...
     * @var int
     */
    const LOG_LEVEL = BAIDU_PUSH_CONFIG::LOG_LEVEL_ONLINE;
